...
#use cpu
#for slow algorithm
#sends stop_cmd with ros but doesn't need
#sets trot run and runs timer to run imu callback that has Move command inside. 
# ++ should incorporate lidar sensor too. 
...
class CrossingNode(Node):
    def __init__(self):
        ...
        # ---- Params for detection (as before)----
        ...
        self.declare_parameter("cmd_topic", "stop_cmd") # Int32 command topic (1=Stop, 0=Go. this program sends 0 after detecting green)
        ...
        #달릴 시간
        self.declare_parameter('auto_exit_sec', 1.0)
