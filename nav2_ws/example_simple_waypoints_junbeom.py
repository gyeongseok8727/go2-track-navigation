...
def main(args=None):
    ...
    # --- 첫 번째 목표 ---
    wp1 = [
        make_pose(2.955737561814483, 3.8427409390552096, -0.2723244291784999, 0.962205490148858), 
    ]
    ...
    # # --- 두 번째 목표 ---
    wp2 = [
        make_pose(5.4233128282686405, 2.4380605603467043, -0.21083619339666024, 0.9775214061871004),
   ]
    mission_cmd2 = None #["ros2", "topic", "pub", "--once", "mission", "std_msgs/msg/Int32", "data: 4"] #4
    node.enqueue_goal(wp2, mission_cmd2)

    # wp3 = [
    #     make_pose(-5.744838367048495, -0.9343919743792538, 0.9668428018515294, 0.25537227043648303),
    # ]
