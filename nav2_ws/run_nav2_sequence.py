...
# === 사용자 환경 설정 ===
MAP_YAML = "/home/mr/nav2_ws/my_map0.yaml"
...
def main():
    try:
        ...
        jaewon_cmd = f"""{ROS_SETUP} && ros2 topic pub -1 /initialpose geometry_msgs/PoseWithCovarianceStamped "{{
                            ...
                            pose: {{
                                pose: {{
                                position: {{x: 1.3309365510940552, y: 4.858049392700195, z: 0.0}},
                                orientation: {{x: 0.0, y: 0.0, z: -0.29924643879406704, w: 0.9541758584606239}}
                                }},
                                covariance: [
        ...
        time.sleep(7)
        # 5) junbeom.py 실행
        junbeom_cmd = f"""{ROS_SETUP} && python3 example_simple_waypoints_junbeom.py"""
